...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('challenges_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='server.challenges')),
            ],
            bases=('server.challenges',),
        ),
        migrations.CreateModel(
            name='ExerciseSet',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='server.acceptedchallenges'),
        ),
        migrations.CreateModel(
